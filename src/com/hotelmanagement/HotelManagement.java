...
public class HotelManagement {
    ...
    public HotelManagement() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotel_db", "root", "rajeev@123");
...
//                String bookingDate = rs.getString("booking_date");
//
//                // Fetching Customer and Room objects
//                Customer customer = getCustomerById(customerId);
//                Room room = getRoomByNumber(roomNumber);
//
//                Booking booking = new Booking(bookingId, customer, room, bookingDate);
...
//    }
//
//    // Helper methods to fetch customer and room by their IDs
//    private Customer getCustomerById(int customerId) {
